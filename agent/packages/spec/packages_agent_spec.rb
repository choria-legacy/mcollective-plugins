...
#      packages_reply   = [{ "name" => "bzip2", "version" => "1.0.5", "release" => "7.el6_0", "status" => 0 }]
#
...
#      packages_reply   = [{ "name" => "testtool", "version" => "1.3.0", "release" => "23.el6", "status" => 0 }]
#
#      result = @agent.call("uptodate", "packages" => packages_request)
#      result.should be_successful
#      result.should have_data_items({"status" => 0, "packages" => packages_reply})
...
#      packages_reply   = [{ "name" => "test-ws-1.0", "version" => "0.1.0SNAPSHOT", "release" => "3333.el6", "status" => 0 }]
#
#      result = @agent.call("uptodate", "packages" => packages_request)
#      result.should be_successful
#      result.should have_data_items({"status" => 0, "packages" => packages_reply})
...
#      packages_reply   = [{ "name" => "test-ws-1.0", "version" => "0.1.0SNAPSHOT", "release" => "2222.el6", "status" => 0 }]
#
#      result = @agent.call("uptodate", "packages" => packages_request)
#      result.should be_successful
#      result.should have_data_items({"status" => 0, "packages" => packages_reply})
...
#      packages_reply   = [{ "name" => "test-ws-1.0", "version" => "0.1.0SNAPSHOT", "release" => "1111.el6", "status" => 0 }]
#
#      result = @agent.call("uptodate", "packages" => packages_request)
#      result.should be_successful
#      result.should have_data_items({"status" => 0, "packages" => packages_reply})
...
#
    it "should report failures when action is uptodate and one package is not available" do
      ...
      packages_reply   = [{ "name" => "testtool",         "version" => "1.3.0", "release" => "23.el6", "status" => 0 },
                          { "name" => "testdoesnotexist", "version" => nil,     "release" => nil,      "status" => 1 }]
    ...
    it "should report success when action is uptodate and one package is given with version" do
      ...
      packages_reply   = [{ "name" => "testtool",         "version" => "1.3.0", "release" => "23.el6", "status" => 0 },
                          { "name" => "test-ws-1.0", "version" => "0.1.0SNAPSHOT", "release" => "3333.el6", "status" => 0 }]
    ...
    # add yum clean expire-cache
    # add re-try when unsuccessful
